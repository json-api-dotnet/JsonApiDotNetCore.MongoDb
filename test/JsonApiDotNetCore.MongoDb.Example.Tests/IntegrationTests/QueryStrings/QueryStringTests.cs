...
namespace JsonApiDotNetCore.MongoDb.Example.Tests.IntegrationTests.QueryStrings
{
    public sealed class QueryStringTests : IClassFixture<IntegrationTestContext<Startup>>
    {
        private readonly IntegrationTestContext<Startup> _testContext;

        public QueryStringTests(IntegrationTestContext<Startup> testContext)
        {
