        ...
        : IClassFixture<IntegrationTestContext<TestableStartup>>
    {
        ...
        public UpdateResourceTests(IntegrationTestContext<TestableStartup> testContext)
        {
            ...
            _testContext.ConfigureServicesAfterStartup(services =>
            {
                ...
                services.AddResourceRepository<MongoEntityRepository<UserAccount, string>>();
        ...
        public async Task Can_update_resource_without_attributes_or_relationships()
        {
            ...
            await _testContext.RunOnDatabaseAsync(async db => await db.GetCollection<UserAccount>(nameof(UserAccount)).InsertOneAsync(existingUserAccount));
        ...
        public async Task Cannot_update_on_resource_ID_mismatch_between_url_and_body()
        {
            ...
            await _testContext.RunOnDatabaseAsync(async db => await db.GetCollection<WorkItem>(nameof(WorkItem)).InsertManyAsync(existingWorkItems));
