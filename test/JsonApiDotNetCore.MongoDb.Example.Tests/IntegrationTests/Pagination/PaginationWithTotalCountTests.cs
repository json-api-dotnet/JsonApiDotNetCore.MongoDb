...
namespace JsonApiDotNetCore.MongoDb.Example.Tests.IntegrationTests.Pagination
{
    public sealed class PaginationWithTotalCountTests : IClassFixture<IntegrationTestContext<Startup>>
    {
        ...
        //     });
        //
        //     var route = $"/blogs/{blog.StringId}/api/v1/articles?page[number]=2&page[size]=1";
        //
        //     // Act
        //     var (httpResponse, responseDocument) = await _testContext.ExecuteGetAsync<Document>(route);
        //
        ...
        //     responseDocument.Links.Should().NotBeNull();
        //     responseDocument.Links.Self.Should().Be("http://localhost" + route);
        //     responseDocument.Links.First.Should().Be($"http://localhost/blogs/{blog.StringId}/api/v1/articles?page[size]=1");
        //     responseDocument.Links.Last.Should().BeNull();
        //     responseDocument.Links.Prev.Should().Be(responseDocument.Links.First);
        //     responseDocument.Links.Next.Should().Be($"http://localhost/blogs/{blog.StringId}/api/v1/articles?page[number]=3&page[size]=1");
        // }
        ...
        //     });
        //
        //     var route = "/blogs?include=articles&page[number]=articles:2&page[size]=2,articles:1";
        //
        //     // Act
        //     var (httpResponse, responseDocument) = await _testContext.ExecuteGetAsync<Document>(route);
        //
        ...
        //     responseDocument.Links.Should().NotBeNull();
        //     responseDocument.Links.Self.Should().Be("http://localhost" + route);
        //     responseDocument.Links.First.Should().Be("http://localhost/blogs?include=articles&page[size]=2,articles:1");
        //     responseDocument.Links.Last.Should().Be("http://localhost/blogs?include=articles&page[number]=2&page[size]=2,articles:1");
        ...
        //     });
        //
        //     var route = $"/blogs/{blog.StringId}/owner?include=articles&page[number]=articles:2&page[size]=articles:1";
        //
        //     // Act
        //     var (httpResponse, responseDocument) = await _testContext.ExecuteGetAsync<Document>(route);
        //
        ...
        //     });
        //
        //     var route = $"/blogs/{blog.StringId}/relationships/api/v1/articles?page[number]=2&page[size]=1";
        //
        //     // Act
        //     var (httpResponse, responseDocument) = await _testContext.ExecuteGetAsync<Document>(route);
        //
        ...
        //     responseDocument.Links.Should().NotBeNull();
        //     responseDocument.Links.Self.Should().Be("http://localhost" + route);
        //     responseDocument.Links.First.Should().Be($"http://localhost/blogs/{blog.StringId}/relationships/api/v1/articles?page[size]=1");
        //     responseDocument.Links.Last.Should().BeNull();
        //     responseDocument.Links.Prev.Should().Be(responseDocument.Links.First);
        //     responseDocument.Links.Next.Should().BeNull();
        // }
        ...
        //     });
        //
        //     var route = "/blogs?include=owner.articles.revisions&" +
        ...
        //     responseDocument.Links.Should().NotBeNull();
        //     responseDocument.Links.Self.Should().Be("http://localhost" + route);
        //     responseDocument.Links.First.Should().Be("http://localhost/blogs?include=owner.articles.revisions&page[size]=1,owner.articles:1,owner.articles.revisions:1");
        //     responseDocument.Links.Last.Should().Be("http://localhost/blogs?include=owner.articles.revisions&page[size]=1,owner.articles:1,owner.articles.revisions:1&page[number]=2");
        //     responseDocument.Links.Prev.Should().Be(responseDocument.Links.First);
        //     responseDocument.Links.Next.Should().BeNull();
        // }
        ...
        // {
        //     // Arrange
        //     var route = "/people?page[number]=doesNotExist:1";
        //
        //     // Act
        //     var (httpResponse, responseDocument) = await _testContext.ExecuteGetAsync<ErrorDocument>(route);
        //
        ...
        // {
        //     // Arrange
        //     var route = "/people?page[size]=todoItems.doesNotExist:1";
        //
        //     // Act
        //     var (httpResponse, responseDocument) = await _testContext.ExecuteGetAsync<ErrorDocument>(route);
        //
        ...
        //     });
        //
        //     var route = $"/blogs/{blog.StringId}/api/v1/articles";
        //
        //     // Act
        //     var (httpResponse, responseDocument) = await _testContext.ExecuteGetAsync<Document>(route);
        //
        ...
        //     responseDocument.Links.Last.Should().BeNull();
        //     responseDocument.Links.Prev.Should().BeNull();
        //     responseDocument.Links.Next.Should().Be($"http://localhost/blogs/{blog.StringId}/api/v1/articles?page[number]=2");
        // }
        //
        // [Fact]
        ...
        //     });
        //
        //     var routePrefix = "/todoItems?filter=equals(owner.lastName,'" + WebUtility.UrlEncode(person.LastName) + "')" +
