...
{
    public sealed class RangeValidationWithMaximumTests : IClassFixture<IntegrationTestContext<Startup>>
    {
        ...
        public RangeValidationWithMaximumTests(IntegrationTestContext<Startup> testContext)
        {
